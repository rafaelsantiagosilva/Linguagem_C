...
//	INICIO
	...
	for(i=0; i<consumidores; i++){
		...
		scanf("%f", &consumo[i]);
		printf("Digite o tipo de código do %dº consumidor: ", i+1);
...
float imprimir_dados(int consumidores, int codigo[], float preco[]){
	for(i=0; i<consumidores; i++){
		printf("\n-------------------------------------------\n");
		printf("PREÇO DO CONSUMIDOR DE CÓDIGO %d", codigo[i]);
		printf("\nR$ %.2f", preco[i]);
		printf("\n-------------------------------------------\n");
	}
	return 0;
...
float imprimir_medias(int consumidores, int tipo_cod[], float consumo[]){
	...
	printf("\n---------------------------------------------\n");
	printf("A MÉDIA DOS CONSUMOS DOS CONSUMIDORES DE TIPO");
	printf("\n2 E 3 É DE: 2 - %.2fkw/h, 3 - %.2fkw/h.", media_consumo2, media_consumo3);
	printf("\nE A MÉDIA DOS DOIS JUNTOS É DE: %.2fkw/h.", media_consumo23);
	printf("\n---------------------------------------------\n");
	return 0;
}
...
float imprimir_total(int consumidores, int tipo_cod[], float consumo[]){
	...
	printf("\n---------------------------------------------\n");
	printf("\nTOTAL DOS 3 TIPOS É: %.2f", total_consumo123);
	printf("\n---------------------------------------------\n");
}
